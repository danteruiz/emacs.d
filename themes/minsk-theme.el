...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(lazy-highlight ((t (:foreground ,h-nb :underline nil))))
   ...
   `(font-lock-variable-name-face ((t (:underline nil))))
